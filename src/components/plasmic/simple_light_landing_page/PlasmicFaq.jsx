...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: GI6t4dr-a2BBI3/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__m6Mdw)}
      >
        <div className={classNames(defaultcss.all, sty.box__kgKx0)}>
          <div className={classNames(defaultcss.all, sty.box___7Grvf)}>
            {p.renderPlasmicSlot({
