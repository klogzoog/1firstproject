...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: Fo0mNaTgDlB3VC/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__yzLC)}
            role={"img"}
