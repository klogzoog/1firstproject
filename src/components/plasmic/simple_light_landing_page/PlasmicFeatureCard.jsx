...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: oviz5ynJ1t8YU/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__ehnuL, {
            [sty.box__long__ehnuLWD74]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__pWwZq, {
              [sty.box__long__pWwZqWD74]: hasVariant(variants, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__vmlUb)}
                  role={"img"}
                />
              ),
      ...
      <div
        className={classNames(defaultcss.all, sty.box__mXk5S, {
          [sty.box__long__mXk5SWD74]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__xkVqP, {
            [sty.box__long__xkVqPWD74]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__mYaWf)}
                role={"img"}
              />
            ),
