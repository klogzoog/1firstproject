...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: rMEog6jLy-MgC/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__ssVhT)}
              role={"img"}
            />
          ),
